...
function Nav() {
    ...
    return (<nav className="relative">
        <div className="flex px-10 py-2 sm:px-20 text-2xl whitespace-nowrap space-x-10 sm:space-x-20 overflow-x-scroll hide-scrollbar"> {/* fetch data from request of assign entries and get the title frm request*/}
            {
